...
import talium.twitchCommands.controller.TriggerDTO;
...
public class CommandEntity {
     ...
     */
    public CommandEntity(String triggerId, String description, List<MessagePattern> patterns, TwitchUserPermission permission, ChatCooldown userCooldown, ChatCooldown globalCooldown, boolean isAutoGenerated, Template template) {
        this.id = triggerId;
    ...
    public CommandEntity(TriggerDTO triggerDTO) {
