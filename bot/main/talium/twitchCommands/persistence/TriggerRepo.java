...
public interface TriggerRepo extends ListCrudRepository<CommandEntity, String> {

    List<CommandEntity> getAllByisAutoGenerated(boolean isUserTrigger);

    @Query(value = "SELECT t.id from CommandEntity t " +
